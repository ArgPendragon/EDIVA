...
CATEGORY_KEYWORDS = {
    ...
    "concetti": ["mitologia", "scienza", "teoria", "storia", "filosofia", "idea", "concept", "theory", "history", "philosophy", "idea"],
    "dialoghi": ["parlò", "disse", "rispose", "esclamò", "dialogo", "conversazione", "dialogue", "conversation", "quote", "speech"],
    "trama": ["evento", "svolta", "finale", "climax", "inizio", "conclusione", "narrazione", "capitolo"],
    "personaggi": ["protagonista", "antagonista", "ruolo", "sviluppo", "carattere", "nome", "biografia"],
    "ambientazioni": ["luogo", "ambientazione", "descrizione", "scenario", "mappa"],
    "concetti": ["mitologia", "scienza", "teoria", "storia", "filosofia", "idea"],
    "dialoghi": ["parlò", "disse", "rispose", "esclamò", "dialogo", "conversazione"],
}

SPECIAL_FOLDERS = ["snippets", "idee"]  # Cartelle di brainstorming da identificare a parte
        ...
        for file in files:
            ...
            if text and len(text.strip()) > 10:
                ...
                if inferred_category not in categories:
                    categories.append(inferred_category)  # Analyze first 500 characters
