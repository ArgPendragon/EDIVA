...
# ------------------------------------------------------------------------------
INPUT_FOLDER = "D:/EDIVA/cardonaproject/processed/1God/slim"   # Folder with JSON files (e.g. chunk001.json, chunk002.json, etc.)
...
def process_file(file_path, relative_path):
    ...
    try:
        response = client.chat.completions.create(
            model="openai/gpt-4o-2024-11-20",  # As per OpenRouter documentation
            messages=[
